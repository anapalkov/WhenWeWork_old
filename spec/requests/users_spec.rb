...
RSpec.describe 'Users', type: :request do # rubocop:todo Metrics/BlockLength
  describe 'POST /signup' do # rubocop:todo Metrics/BlockLength
    context 'with matching password confirmation' do # rubocop:todo Metrics/BlockLength
      let!(:user_params) do
        {
          username: 'test_user',
  ...
  describe 'GET /me' do # rubocop:todo Metrics/BlockLength
