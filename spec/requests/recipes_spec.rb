...
RSpec.describe 'Recipes', type: :request do # rubocop:todo Metrics/BlockLength
  let!(:user) { User.create(username: 'test_user', password: 'sup3r-secret', image_url: 'https://via.placeholder.com/150', bio: 'bio') }

  describe 'GET /recipes' do # rubocop:todo Metrics/BlockLength
    before do
      Recipe.create([
                      {
                        user_id: user.id,
    ...
    context 'with a logged in user' do # rubocop:todo Metrics/BlockLength
      before do
  ...
  describe 'POST /recipes' do # rubocop:todo Metrics/BlockLength
    context 'with a logged in user and valid data' do # rubocop:todo Metrics/BlockLength
